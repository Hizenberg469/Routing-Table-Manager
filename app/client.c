...
/*
* Optionally, display contents of a data
* structure (routing table or MAC list).
*/
...
int main() {
	...
	/*
	* Continously wait for updates to routing table and MAC list
	* from the server regarding table contents and server state.
	*/
